...
// Ported from ProtocolV2Reference/Negotiation.cs (docs/protocol-v2-design.md §5) as part of
...
// Hello-retry timer in LocalNode - see the "#region JFP2" section of JoinFS/Node.cs.
...
namespace JoinFS.Jfp2
{
    ...
    public sealed class PeerSession
    {
        ...
        /// for the rest of the session and addressed via the full, untouched legacy Node.cs/Network.cs
        /// path instead. No capability of this peer is ever assumed beyond what the legacy protocol
        /// already provides.
        /// </summary>
        public bool AssumedLegacy;

        /// <summary>
        /// How many Hello attempts LocalNode has made to this peer so far. Not part of the original
        /// reference implementation (which never drove a real retry loop) - added for
        /// LocalNode.DoJfp2Handshake's retry/AssumedLegacy-timeout logic.
        /// </summary>
        public int HelloAttempts;

        /// <summary>
        /// main.ElapsedTime value at which LocalNode.DoJfp2Handshake should retry the Hello (or give
